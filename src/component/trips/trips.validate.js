...
exports.TripsValidation = joi.object({
  ...
  description_ar: joi.string().required().min(15).max(100000).message('Description (Arabic) is required and must be at least 20 characters long'),
  description_en: joi.string().required().min(15).max(100000).message('Description (English) is required and must be at least 20 characters long'),
