...
exports.TripsValidation = joi.object({
  ...
  description_ar: joi.string().required().min(30).max(100000).message('Description (Arabic) is required and must be at least 20 characters long'),
  ...
  place_en: joi.string().required().min(30).max(20).message('Place (English) is required and must be at least 2 characters long'),
